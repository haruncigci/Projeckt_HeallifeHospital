...
public class ReusableMethods {
    ...
    void waitFor(int sec)  132.satir
     WebElement waitForVisibility(WebElement element, int timeToWaitInSec)  142. satir
     WebElement waitForVisibility(WebElement element, int timeToWaitInSec) 148.satir
     ...
     void waitAndSendTextWithDefaultTime(WebElement element, String text)  281.satir
...
void selectAnItemFromDropdown(WebElement item, String selectableItem)  396.satir
